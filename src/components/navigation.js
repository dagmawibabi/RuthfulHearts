...
export default function Navigation() {
  return (
    <div className="w-screen border-b border-b-cyan-950 border-opacity-50 p-5 items-center sticky top-0 left-0 right-0 bg-[#151515] backdrop-blur-xl bg-opacity-80 z-50
       md:justify-between
    ...
    ">
      <div className="flex justify-center">
        <img src={logo} alt="logo" className="w-60
          sm:w-72  lg:w-72 xl:w-72 2xl:w-72
        "></img>
      </div>
      <div className="flex items-center justify-center gap-3 font-bold text-sm  uppercase cursor-pointer duration-300
        pt-5 
        lg:justify-between 
        ...
        ">
          <a href="/#donate" rel="noreferrer">
            <div className="duration-300 rounded-full text-emerald-500
              ...
              sm:text-black lg:text-black xl:text-black 2xl:text-black
              sm:bg-cyan-500 lg:bg-cyan-500 xl:bg-cyan-500 2xl:bg-cyan-500
          ...
          <a href="/#thanks" rel="noreferrer" className="hidden md:block">
            <div className="duration-300 rounded-full text-pink-400
              ...
              sm:py-2 lg:py-2 xl:py-2 2xl:py-2
              sm:text-black lg:text-black xl:text-black 2xl:text-black
              sm:bg-pink-400 lg:bg-pink-400 xl:bg-pink-400 2xl:bg-pink-400
              lg:hover:bg-white xl:hover:bg-white 2xl:hover:bg-white 
            ">
              <span> Thank You </span>
            </div>
          </a>
